...
class Strings {
  ...
  static const IntroTitle = "Flexible Timing Services";
  static const IntroTitle2 = "Flexible Timing Services";
  static const Intro_SubTitle = "Enable Multiple services and work any time of the day";
  ...
  static const contact_driver = "Contacting Drivers Nearby";
  static const your_ride_cnfm = "Your ride is confirmed";
  static const paytm_title = "Pay via Paytm wallet and get cashback...";
  static const paytm_sub_title = "Pay via Paytm wallet and get cash back up to Rs.400 for your first 2 booking";
  ...
  "The Privacy Policy covers both “online” (e.g., web and mobile services, including any websites operated by us such"
      " as https://www.urataxi.com/ or Mobile Application, however accessed and/or used, whether via personal computers,"
      " mobile devices or otherwise) and “offline” (e.g., collection of data through mailings, telephone, or in person) "
      "activities owned, operated, provided, or made available by the Company. Our “online” and “offline” activities, in"
      " relation to facilitation of taxi hire services through a network of third party drivers and taxi operators,"
      " are collectively referenced as the “Services”."
  "This Privacy Policy also applies to your use of interactive features or downloads that: (i) we own or control; (ii)"
  "are available through ura’s Services; or (iii) interact with the Services and post or incorporate this Privacy Policy."
  "BY ACCEPTING THE CUSTOMER TERMS AND CONDITIONS, YOU AGREE TO THE TERMS OF THIS PRIVACY POLICY. Please review the following "
  "carefully so that you understand our privacy practices. If you do not agree to this Privacy Policy, do not accept the Customer "
 ...
 " have the meaning as provided hereunder:"
  ...
  “OEM” shall mean ura Electric Mobility Private Limited, a company incorporated under the Companies Act, 2013 and having its 
  corporate office at Regent Insignia, #414, 3rd Floor, 4th Block, 17th Main, 100 Feet Road, Koramangala, Bangalore - 560 034, 
  ...
  “Protected Information” shall mean such categories of information that could reasonably be used to identify you personally,
  ...
  Your geolocation
  Information about how you interact with the Mobile Application and any of our web sites to which the Mobile Application links,
   such as how many times you use a specific part of the Mobile Application over a given time period, the amount of time you spend using the Mobile Application, 
   how often you use the Mobile Application, actions you take in the Mobile Application and how you engage with the Mobile Application Information to allow us to personalize the services and content available through the Mobile Application
  Data from SMS/ text messages upon receiving Device permissions for the purposes of (i) issuing and receiving one time passwords and
   other device verification, and (ii) automatically filling verification details during financial transactions, either through us or a third-party service provider,
    in accordance with applicable law. We do not share or transfer SMS/ text message data to any third party other than as provided under this Privacy Policy.
  INFORMATION COLLECTED BY TPSP ADVERTISING ON ura WEBSITE OR MOBILE APPLICATIONS"""
 " ura may have advertised TPSP services/ products on its website or mobile application.";

  static const privacy_policy3= """ Our primary goal in collecting your information is to provide you with an enhanced experience when using the Services. We use your information to closely monitor which features of the Services are used most, to allow you to view your trip history, rate trips, and to determine which features we need to focus on improving, including usage patterns and geographic locations to determine where we should offer or focus services, features and/or resources.
  ...
  static const privacy_policy4=""" We may ask you to provide us with certain Protected Information. We may collect this information through various means and
 in various places through the Services, including account registration forms, contact us forms, or when you otherwise
  interact with us. When you sign up to use the Services, you create a user profile. We shall ask you to provide only such
  Protected Information which is for lawful purpose connected with our Services and necessary to be collected by us for such
  ...
  In case of booking via call center, ura may record calls and chat histories for quality and training purposes.
  In case you book/ purchase a vehicle through ‘ura Cars’, we may collect your vehicle preferences, your preferred address for test drives, car insurance details, purchase history and information pertaining to the service package purchased, and any additional documents that you may have shared with us, to facilitate such sale/ purchase of vehicle(s).
  ...
  In case you use your account to book a cab ride for someone else from your contact list using the Services, we will be collecting and storing such contact information and share the ride details with that selected contact.
  Usage Information may be collected using a cookie. If you do not want information to be collected through the use of cookies, your browser allows you to deny or accept the use of cookies. Cookies can be disabled or controlled by setting a preference within your web browser or on your Device. If you choose to disable cookies or flash cookies on your
   Device, some features of the Services may not function properly or may not be able to customize the delivery of information to you. The Company cannot control the use of cookies (or the resulting information) by third parties, and use of third party cookies is not covered by our Privacy Policy. """"";
